...
public class CachedMetaDataTest extends JDBCMetaDataBinderTestCase {
	...
	public void testCachedDialect() {
		...
		MetaDataDialect realMetaData = JDBCReaderFactory.newMetaDataDialect( dialect(), cfg.getProperties() );
		...
		JDBCReader reader = JDBCReaderFactory.newJDBCReader(serviceRegistry(), buildSettings, new DefaultReverseEngineeringStrategy(), dialect );
		...
		reader = JDBCReaderFactory.newJDBCReader(serviceRegistry(), buildSettings, new DefaultReverseEngineeringStrategy(), dialect );
