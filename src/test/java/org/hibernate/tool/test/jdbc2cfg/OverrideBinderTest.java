...
public class OverrideBinderTest extends JDBCMetaDataBinderTestCase {
    ...
    public void testReadTypeMappings() {
        ...
        assertEquals(
                "int",
                repository.columnToHibernateTypeName(
                        null,
                        null,
                        Types.INTEGER,
                        5,
        ...
        assertEquals(
                "Long",
                repository.columnToHibernateTypeName( null, null, Types.NUMERIC, 1, 10, 0, false, false )
        );
        assertEquals(
                "java.lang.Long",
                repository.columnToHibernateTypeName(
        ...
        assertEquals(
                "java.lang.Long",
                repository.columnToHibernateTypeName( null, null, Types.NUMERIC, 1, 10, 43, false, false )
        );
    ...
    public void testDocExample() {
        ...
        assertEquals(
                "your.package.TrimStringUserType",
                repository.columnToHibernateTypeName(
                        null,
                        "NAME",
                        Types.VARCHAR,
    ...
    public void testSchemaSelection() {
        ...
        configuration.readFromJDBC(serviceRegistry());
    ...
    public void testColumnTypeMappings() {
        ...
        assertEquals(
                "string",
                repository.columnToHibernateTypeName(
                        new TableIdentifier( null, null, "ORDERS" ),
                        "NAME",
                        0,
                        0,
                        0,
        ...
        PersistentClass classMapping = getJDBCMetaDataConfiguration().getClassMapping( "Orders" );
        ...
        classMapping = getJDBCMetaDataConfiguration().getClassMapping( "MiscTypes" );
    ...
    public void testColumnPropertyNameMappings() {
        ...
        assertEquals(
                "orderName",
                repository.columnToPropertyName( new TableIdentifier( null, null, "ORDERS" ), "NAME" )
        );
    }
    ...
    public void testIdGenerator() {
        ...
        assertEquals(
                "sequence",
                sv.getIdentifierGeneratorStrategy()
        ); // will fail if default schema is not set since then there is no match in the override binder
    ...
    public void testReadPackageName() {
        ...
        assertEquals(
                "org.werd.MyWorld",
                repository.tableToClassName( new TableIdentifier( null, "Werd", "TBL_PKG" ) )
        );
        assertEquals(
                "other.MyWorld",
                repository.tableToClassName( new TableIdentifier( null, "Werd", "TBL_OTHER" ) )
        );

    }

    public Table findTable(String name) {
        Iterator tableIter = getJDBCMetaDataConfiguration().getTableMappings();
    ...
    public void testSQLTypeMappingComparisons() {
        SQLTypeMapping one = new SQLTypeMapping(
                Types.BIGINT,
                5,
                SQLTypeMapping.UNKNOWN_PRECISION,
                SQLTypeMapping.UNKNOWN_SCALE,
                SQLTypeMapping.UNKNOWN_NULLABLE
        );
        SQLTypeMapping two = new SQLTypeMapping(
                Types.BIGINT,
                SQLTypeMapping.UNKNOWN_LENGTH,
                3,
                SQLTypeMapping.UNKNOWN_SCALE,
        ...
        SQLTypeMapping generic = new SQLTypeMapping(
                Types.BIGINT,
                SQLTypeMapping.UNKNOWN_LENGTH,
                SQLTypeMapping.UNKNOWN_PRECISION,
                SQLTypeMapping.UNKNOWN_SCALE,
    ...
    public void testSimpleUserDefinedForeignKeys() {
        ...
        classMapping = getJDBCMetaDataConfiguration().getClassMapping( "Customer" );
    ...
    public void testCompositeUserDefinedForeignKeys() {
        ...
        PersistentClass classMapping = getJDBCMetaDataConfiguration().getClassMapping( "Children" );
        Property property = classMapping.getProperty( "propertyParent" );
        assertEquals( 2, property.getColumnSpan() );

        classMapping = getJDBCMetaDataConfiguration().getClassMapping( "Parent" );
    ...
    public void testTypes() {
        ...
        PersistentClass classMapping = getJDBCMetaDataConfiguration().getClassMapping( "MiscTypes" );
    ...
    public void testTableToClass() {
        ...
        ReverseEngineeringStrategy res = buildOverrideRepository().addResource( OVERRIDETEST_REVENG_XML )
