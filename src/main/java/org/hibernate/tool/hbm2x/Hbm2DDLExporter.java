...
public class Hbm2DDLExporter extends AbstractExporter {
    ...
    public Hbm2DDLExporter(Configuration cfg, ServiceRegistry serviceRegistry, File outputdir) {
    ...
    protected void doStart() {
        ...
        if ( schemaUpdate ) {
            SchemaUpdate update = new SchemaUpdate(getServiceRegistry(), configuration );
            ...
            // hibernate core prior versions is set
                ...
                try {
                    ...
                    if ( null != outputFileName ) {
                        Method setOutputFile = schemaUpdateClass.getMethod(
                                "setOutputFile",
                                new Class[] { String.class }
                        );
                        setOutputFile.invoke(
                                update, new Object[] {
                                new File(
                                        getOutputDirectory(),
                                        outputFileName
                        ...
                        Method setDelimiter = schemaUpdateClass.getMethod(
                                "setDelimiter",
                                new Class[] { String.class }
                        );
                        setDelimiter.invoke( update, new Object[] { delimiter } );

                        Method setFormat = schemaUpdateClass.getMethod(
                                "setFormat",
                    ...
                    if ( haltOnError ) {
                        Method setHaltOnError = schemaUpdateClass.getMethod(
                                "setHaltOnError",
                                new Class[] { boolean.class }
                        );
                    ...
                    log.error(
                            "Error during DDL export, this version of hibernate doesn't support following " +
            ...
            SchemaExport export = new SchemaExport(getServiceRegistry(), configuration );
            if ( null != outputFileName ) {
