            ...
            if ( !( dbTypeCode == modelTypeCode ) ) {
                pc.reportIssue(
                        new Issue(
                                ...
                                + JDBCToHibernateTypeHelper.getJDBCTypeName( modelTypeCode ) + " but was " + JDBCToHibernateTypeHelper
                                .getJDBCTypeName( dbTypeCode ) + " in db"
                        )
                );
            }
        }
