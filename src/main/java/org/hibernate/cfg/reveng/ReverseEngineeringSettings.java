...
public class ReverseEngineeringSettings {
    ...
    public ReverseEngineeringSettings setDefaultPackageName(String defaultPackageName) {
        this.defaultPackageName = defaultPackageName == null ? "" : defaultPackageName.trim();
        return this;
    }
    ...
    /**
     * If true, reverse engineering strategy will try and auto detect columns for optimistic locking, e.g. VERSION and TIMESTAMP
     */
    public boolean getDetectOptimisticLock() {
    ...
    /**
     * if true, a collection will be mapped for each foreign key
     */
    ...
    /**
     * if true, a many-to-one association will be created for each foreign key found
     */
