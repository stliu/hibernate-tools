...
public class JDBCMetaDataConfiguration extends Configuration {
	...
	public void readFromJDBC() {
        ServiceRegistry serviceRegistry = null;     //todo fixme
		JDBCBinder binder = new JDBCBinder(this, serviceRegistry, buildSettings(serviceRegistry), createMappings(),revEngStrategy);
